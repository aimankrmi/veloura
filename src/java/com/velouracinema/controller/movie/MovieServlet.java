...
protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    if ("details".equals(action)) { // Movie Details
        ...
        if (movieIdParam != null) {
            ...
            response.sendRedirect("homepage.jsp"); // Redirect if no ID is provided
        }
    } else if ("list".equals(action)) { // List Movies for "Now Showing" or "Coming Soon"
        List<Movie> nowShowingMovies = MovieDAO.getMoviesByStatus("now");
        List<Movie> comingSoonMovies = MovieDAO.getMoviesByStatus("coming");
