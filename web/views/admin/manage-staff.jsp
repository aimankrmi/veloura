                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <button type="button" class="btn btn-primary m-1" data-bs-toggle="modal"
                                                data-bs-target="#editstaff${staff.id}Modal">
                                            Edit staff
                                        </button>
                                        ...
                                        <form action="${pageContext.request.contextPath}/updateStaff" method="POST" >
                                            ...
                                            <div class="modal fade" id="editstaff${staff.id}Modal" tabindex="-1"
                                                 aria-labelledby="editstaff${staff.id}ModalLabel" aria-hidden="true">
                                                <div class="modal-dialog model-dialog-centered modal-dialog-scrollable">
                                                    <div class="modal-content bg-dark">
                                                        <div class="modal-header">
                                                            <h1 class="modal-title fs-5 text-white" id="editstaff${staff.id}ModalLabel ">Staff
                                                                Details</h1>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                    aria-label="Close" style="background-color: var(--color-light-gold);"></button>
                                                        </div>
                                                        <div class="modal-body text-white">
                                                            ...
                                                            <!-- STAFF NAME -->
                                                            <div class="mb-3">
                                                                <label for="staffName${staff.id}FormControlInput" class="form-label">
                                                                    Name</label>
                                                                <input type="text" class="form-control bg-dark text-white"
                                                                       id="staffName${staff.id}FormControlInput" name="staffName" value="<c:out value='${staff.name}'/>" required>
                                                            </div>

                                                            <!-- USERNAME -->
                                                            <div class="mb-3">
                                                                <label for="staffUsername${staff.id}FormControlInput" class="form-label">Username</label>
                                                                <input type="text" class="form-control bg-dark text-white"
                                                                       id="staffUsername${staff.id}FormControlInput" name="staffUsername" value="<c:out value='${staff.username}'/>" required>
                                                            </div>

                                                            <!-- EMAIL -->
                                                            <div class="mb-3">
                                                                <label for="staffEmail${staff.id}FormControlInput" class="form-label">Email</label>
                                                                <input type="text" class="form-control bg-dark text-white"
                                                                       id="staffEmail${staff.id}FormControlInput" name="staffEmail" value="<c:out value='${staff.email}'/>" required>

                                                            </div>

                                                            <!-- PHONE NO -->
                                                            <div class="mb-3">
                                                                <label for="staffPhoneNo${staff.id}FormControlInput" class="form-label">
                                                                    Phone No</label>
                                                                <input type="text" class="form-control bg-dark text-white"
                                                                       id="staffPhoneNo${staff.id}FormControlInput" name="staffPhoneNo" value="<c:out value='${staff.phoneNo}'/>" required>
                                                            </div>
